...
public class JpaCommentDaoIT {
    ...
    public void testGetCommentByName() throws Exception {
        Comment comment = commentEJB.getCommentByName("commentName1");
    ...
    public void testDeleteComment() throws Exception {
        ...
        entityTransactionComment.commit();
        Comment comment2 = commentEJB.getCommentByName("commentName1");
        assertNull(comment2);
    }
    @Ignore
    @Test
    public void testUpdateComment() throws Exception {
        ...
        assertEquals(updatedComment.getVotes(), "updatedBody");
    }
    @Ignore
    @Test
