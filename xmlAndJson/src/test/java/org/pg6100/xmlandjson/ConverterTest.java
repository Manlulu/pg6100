...
import org.pg6100.xmlandjson.data.Post;
...
public class ConverterTest {
    ...
    public void testAutomatedFiles(){
        ...
        org.pg6100.xmlandjson.automated.TopPosts tp = new org.pg6100.xmlandjson.automated.TopPosts();

        String xml = automated.toXML(tp);

        org.pg6100.xmlandjson.automated.TopPosts res = automated.fromXML(xml);
